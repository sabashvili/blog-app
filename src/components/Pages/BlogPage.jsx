    ...
    <>
      ...
      <section className={classes["blog-section"]}>
        ...
        <div className={classes["date-author-container"]}>
          ...
          <h6>•</h6>
          <h6 className={classes["blog-author-email"]}>lile.kvaratskhelia@redberry.ge</h6>
        </div>
        <h1 className={classes["blog-title"]}>მობილური ფოტოგრაფიის კონკურსის გამარჯვებულთა ვინაობა ცნობილია</h1>
